...
1. **Склонируйте этот репозиторий: <code>git clone https://github.com/Ultra119/stellaris-dlc-unlocker-linux.git</code>**

2. **Инициализируйте venv: <code>python -m venv venv && source venv/bin/activate</code>**

3. **Установите зависимости с помощью: <code>pip install -r requirements.txt</code>**

4. **Откройте программу Stellaris DLC Unlocker командой <code>python main.py</code> и следуйте инструкциям установщика на вашем устройстве.**
